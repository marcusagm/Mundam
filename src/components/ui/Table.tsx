...
export interface TableProps<T> {
    ...
    /** Callback when visible items change (for virtualization hooks like priority loading) */
                            ...
                            <div class="ui-table-empty-state" role="row" aria-rowindex="2">
                                ...
                                <div class="ui-table-empty-description">
                                    {local.emptyDescription ||
                                        'Adjust your filters or add items to see data here.'}
                                </div>
                            </div>
                        );
                    })()}
