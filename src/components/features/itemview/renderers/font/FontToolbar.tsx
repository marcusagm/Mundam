        ...
        <>
            <div class="toolbar-group">
                <Tooltip position="bottom" content="Font Size">
                    <div class="font-control-group">
                        ...
                        <span class="font-control-value">{Math.round(fontSettings().fontSize)}</span>
                    </div>
                </Tooltip>
                ...
                <Tooltip position="bottom" content="Line Height">
                 ...
                 <Tooltip position="bottom" content="Letter Spacing">
                    <div class="font-control-group">
                        <AlignJustify size={14} class="font-icon" style={{ transform: "rotate(90deg)" }} />
                        <div style={{ width: "80px" }}>
                            <Slider 
                                min={-5} 
                                max={20} 
            ...
            <div class="toolbar-group">
                <Popover
                    trigger={
                        <Button variant="ghost" class="font-color-btn">
                            <div class="font-color-preview" style={{ background: fontSettings().color }} />
                            Text Color
                        </Button>
                    }
                >
                ...
                <Popover
                    trigger={
                        <Button variant="ghost" class="font-color-btn">
                             <div class="font-color-preview" style={{ background: fontSettings().backgroundColor, "border-radius": "2px" }} />
                            Bg Color
                        </Button>
                    }
                >
